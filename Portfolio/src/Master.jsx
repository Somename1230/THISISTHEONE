...
export default function Main({handleContact, handleAbout, handleSkillset}) {
  ...
  return(
    ...
    className="bg-transparent border-white fixed border-14 w-full h-full z-40 select-none"
    >
      
    <div className="absolute top-0 left-0 w-full h-24 bg-black/70 z-40"></div>
    <div className="flex justify-evenly mt-7 text-white text-base md:text-lg lg:text-2xl xl:text-4xl z-40 relative">
