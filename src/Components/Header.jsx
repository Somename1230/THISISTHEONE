...
import img10 from '../Pictures/Austin.png'
...
<div className="olive w-8/10 lg:w-5/10 m-13 h-9/10 absolute mt-10 rounded-4xl right-0 text-white max-h-200">
    ...
    <h1 className="text-4xl text-slate-300 mt-20 ml-4 xl:text-6xl">ABOUT ME</h1>
    ...
    onClick={propButton}
    className="absolute top-24 right-4 bg-olive-light text-white border border-white text-sm font-semibold py-2 px-4 rounded-full hover:bg-white hover:text-lime-800 duration-300 z-50">
      READY FOR WORK</motion.button>
    ...
    <p className="mt-10 m-4 xl:text-2xl">I specialize in building fully responsive, visually engaging websites that not only adapt seamlessly to any device or screen size, but also prioritize clean, modern design principles. My goal is to ensure that each site offers a smooth, intuitive user experience while maintaining a polished and professional aesthetic throughout.</p>
      ...
      <a href="https://www.instagram.com/theglowsites/" target="_blank">
      <h2 className="text-lg text-indigo-600 ml-4 absolute bottom-0 mb-15 xl:text-3xl">INSTAGRAM</h2>
      </a>
...
<div><img src={img10}
className="w-100 absolute top-355 left-2/8 -translate-x-1/2 z-20 
hidden lg:block xl:w-140 xl:top-328" alt="Austin"
/>
</div>
  </>
    )
